...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#071b43] text-white font-header">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Left: Logo + Contact */}
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              <Image src="/logo-pkbm-sehati-bgremove.png" alt="Logo" className="h-14 w-auto" width={800}
            height={450} />
              <div>
                <h3 className="text-[#0AC4E0] font-semibold text-lg">
                  PKBM Sehati
                </h3>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <a aria-label="Facebook" href="#" className="p-2 rounded-full bg-[#0992C2] hover:bg-[#0AC4E0] transition">
              ...
              <a aria-label="Instagram" href="#" className="p-2 rounded-full bg-[#0992C2] hover:bg-[#0AC4E0] transition">
              ...
              <a aria-label="YouTube" href="#" className="p-2 rounded-full bg-[#0992C2] hover:bg-[#0AC4E0] transition">
          ...
          <div className="md:border-l md:border-r md:border-[#0992C2] md:px-8 flex flex-col md:items-center">
            <nav className="grid grid-cols-2 md:grid-cols-1 gap-2 text-sm text-gray-200">
              <a href="#beranda" className="hover:text-[#0AC4E0]">Beranda</a>
              <a href="#tentang" className="hover:text-[#0AC4E0]">Tentang</a>
              <a href="#program" className="hover:text-[#0AC4E0]">Program</a>
              <a href="#fasilitas" className="hover:text-[#0AC4E0]">Fasilitas</a>
              <a href="#aktivitas" className="hover:text-[#0AC4E0]">Aktivitas</a>
              <a href="#daftar" className="hover:text-[#0AC4E0]">Daftar</a>
            </nav>
          ...
          <div className="flex flex-col justify-between">
            <div>
              <h4 className="text-[#0AC4E0] font-semibold mb-2">Alamat</h4>
            ...
            <div className="mt-6 md:mt-0">
              <p className="text-gray-400 text-xs">&copy; {new Date().getFullYear()} PKBM Sehati. All rights reserved.</p>
            </div>
          </div>
        </div>

        {/* thin rule */}
        <div className="border-t border-[#0992C2] mt-8 pt-6 flex items-center justify-between">
      ...
      <button
        ...
        className={`fixed right-6 bottom-6 z-50 p-3 rounded-md bg-[#0992C2] hover:bg-[#0AC4E0] text-white shadow-lg transition-opacity ${showTop ? "opacity-100" : "opacity-0 pointer-events-none"}`}
      >
