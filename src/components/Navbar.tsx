...
export default function Navbar() {
  ...
  return (
    <nav className="bg-transparent backdrop-blur-sm fixed w-full z-50 top-0 left-0 font-header">
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex-shrink-0 flex items-center">
            <Image
              ...
              src="/logo-pkbm-sehati-bgremove.png"
              alt="Logo"
              width={500}
            height={250}
            />
          ...
          <div className="hidden md:flex md:items-center md:space-x-8">
            <a
              href="#beranda"
              className="text-white font-semibold hover:text-[#0992C2]"
            >
              Beranda
            </a>
            <a
