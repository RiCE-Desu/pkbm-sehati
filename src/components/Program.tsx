...
export default function Program() {
  ...
  return (
    <section
      id="program"
      className="font-['Be_Vietnam_Pro'] bg-[#0B2D72] text-white px-4 md:px-12 lg:px-50"
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative flex items-center">
          ...
          <div className="hidden md:flex w-full items-center">
            ...
            <button
              onClick={prevSlide}
              className="cursor-pointer p-3 border border-white bg-[#071b43] bg-opacity-80 hover:bg-[#D9C47C] hover:text-black transition-all duration-300"
            ...
            <div className="flex overflow-hidden">
              {programs
                ...
                .map((program) => (
                  <div
                    key={program.id}
                    className="relative group overflow-hidden shadow-lg bg-[#071b43] h-120 min-w-0"
                  >
                    <Image
                      src={program.img}
                      alt={program.title}
          ...
          <div className="md:hidden relative w-full overflow-hidden">
            ...
            <div className="flex items-center justify-center mt-10 px-2 gap-5">
              <button
                onClick={prevSlide}
                className="p-3 border border-white bg-[#071b43] bg-opacity-80 hover:bg-[#D9C47C] hover:text-black transition-all duration-300"
              >
                {/* Left Arrow SVG */}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
